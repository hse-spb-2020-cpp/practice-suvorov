...
auto print(std::ostream &os, const T &value) -> decltype(os << value, std::declval<void>()) {
//auto print(std::ostream &os, const T &value) -> decltype(static_cast<void>(os << value)) {
    os << value;
}

template<typename T>
auto print(std::ostream &os, const T &container) -> decltype(os << *container.begin(), container.end(), std::declval<void>()) {
...
auto print_integral(std::ostream &os, const T &value) ->
    ...
    /* TODO: use std::enable_if and std::is_integral */ {
    os << value;
}
...
struct wrapper {
    ...
    std::enable_if_t<std::is_integral_v<T>, T> get_integral() {
        return value;
    }
};
